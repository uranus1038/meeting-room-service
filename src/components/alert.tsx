...
export class Alert extends Component {
    render(): ReactNode {
        return(
        <>
            <div className="bg-[#7B66FF] text-center py-3 lg:px-3">
                <div className="p-2 bg-indigo-600 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex" role="alert">
                    ...
                    <span className="font-semibold mr-2 text-left text-sm flex-auto">ระบบจองห้องประชุมออนไลน์ ในรูปแบบเว็บไซต์สำเร็จรูป รองรับการจองห้องประชุมได้ตลอด 24 ชั่วโมง</span>
