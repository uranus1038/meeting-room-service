...
export class ServiceComponent extends Component<{}, MyState> {
    constructor(props: {}) {
        super(props)
    ...
    render(): ReactNode {
        return (
            <div className="ms-72 p-6">
                <h2 className="text-xl font-light">บริการอื่นๆ</h2>
                <Breadcrumb className="mt-2 " aria-label="Default breadcrumb example ">
                    <Breadcrumb.Item  >
                        หน้าหลัก
                    </Breadcrumb.Item>
                    <Breadcrumb.Item >บริการอื่นๆ</Breadcrumb.Item>
                </Breadcrumb>
                <div className="flex items-start justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white dark:bg-gray-900">
                    <div className="font-bold text-2xl"> <i className="fas fa-tags me-3 font-bold text-2xl"></i>แท็กบริการ</div>
                </div>
